        ...
        <div id="content" class="p-4 p-md-5">
            ...
            <div class="students-section">
                <h1 class="heading">List Des Departements</h1>
                    <form action="${pageContext.request.contextPath}/recherche_departement" method="POST" style="margin-bottom: 5px;">
                ...
                <table>
                    ...
                    <tbody>               
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="${pageContext.request.contextPath}/delete_departement?id=<%=departement.getId()%>" class="link">Suppremer</a>
                            </td>
                        </tr>
                        <% } %>
                    </tbody>
